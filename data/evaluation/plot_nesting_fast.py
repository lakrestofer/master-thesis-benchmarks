...
def create_nesting_level_plot(timestamps, nesting_levels, event_types, aspects, attributes, aspect_colors, downsample_to=10000):
    """
...
def plot_computation_nesting(csv_path: Path, rendering_mode: RenderingMode, downsample_to: int):
    """
    ...
    fig = create_nesting_level_plot(timestamps, nesting_levels, event_types,
                                      aspects, attributes, aspect_colors, downsample_to=downsample_to)
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        default=10000,
        type=int,
        help='How many datapoint we should downsample to',
    )
    ...
    plot_computation_nesting(csv_path, rendering_mode, downsample_to)
